...
module.exports = function(lesson, s) {
	...
	var data = {
		...
		showBack: true,
		hasPractice: fs.existsSync(path.join(lessonBasePath, 'practice')) || fs.existsSync(path.join(lessonBasePath, 'practice.js')),
		hasSolution: fs.existsSync(path.join(lessonBasePath, 'solution')) || fs.existsSync(path.join(lessonBasePath, 'solution.js'))
	};
